...
on the system there are n packages installed
...
table ldlnkdirs
dirname TEXT PRIMARY KEY NOT NULL contains directories with libraries that have symlinks in a lddir
...
useful for developers or users that have special configurations for own installed packages
on other library directories exported via LD_LIBRARY_PATH/LD_RUN_PATH
